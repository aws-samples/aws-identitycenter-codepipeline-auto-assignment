...
def validate_file_name_matches_content(file_name: str, content_name: str) -> bool:
    """
    Validate that the JSON file name (without extension) matches the Name field in content.
...
def verify_policy_name_matches_arn(name: str, arn: str) -> bool:
    ...
    Example: name="AdministratorAccess", arn="arn:aws:iam::aws:policy/AdministratorAccess"
    """
    try:
